...
while True:
    ...
    blob = cv2.dnn.blobFromImage(frame,1.0, (300, 300), (104.0, 177.0, 123.0)) #багатовимірний масив із зображеннями готовой моделі
    ...
    for i in range(detections.shape[2]):
        ...
        if confidence > 0.5:
            ...
            x, y = max(0, x), max(0, y)
            x2, y2 - min(w - 1, x2), min(h - 1, y2) #тільки детактована зона нам потрібна
