...
#
#
# train_ds = tf.keras.preprocessing.image_dataset_from_directory("data/train", image_size = (128, 128),
#                                                                batch_size = 32, label_mode = "categorical")
# test_ds = tf.keras.preprocessing.image_dataset_from_directory("data/test", image_size = (128, 128),
#                                                                batch_size = 32,label_mode = "categorical")
#
